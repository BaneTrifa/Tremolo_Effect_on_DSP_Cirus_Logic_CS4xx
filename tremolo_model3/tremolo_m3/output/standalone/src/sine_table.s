...
_gen_sin:			/* LN: 31 | CYCLE: 0 | RULES: () */ 
	...
	xmem[i0] = a0l			# LN: 31 | 
cline_31_0:			/* LN: 43 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x6)			# LN: 43 | 
	a0 = 0			# LN: 43 | 
	a0g = (0x51)			# LN: 43 | 
...
cline_43_0:			/* LN: 44 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x6)			# LN: 44 | 
	a0g = xmem[i0]; i0 += 1			# LN: 44, 44 | 
	a0h = xmem[i0]; i0 += 1			# LN: 44, 44 | 
	a0l = xmem[i0]			# LN: 44 | 
	do (0x8), label_end_10_0			# LN: 44 | 
label_begin_10_0:			/* LN: 44 | CYCLE: 0 | RULES: (CBitwiseFixPointShiftConstNonstandardValue) */ 
label_end_10_0:			# LN: 44 | CYCLE: 0 | RULES: (CBitwiseFixPointShiftConstNonstandardValue)
	a0 = a0 >> 1			# LN: 44 | 
	i0 = i7 - (0x6)			# LN: 44 | 
	xmem[i0] = a0g; i0 += 1			# LN: 44, 44 | 
	xmem[i0] = a0h; i0 += 1			# LN: 44, 44 | 
	xmem[i0] = a0l			# LN: 44 | 
...
cline_45_0:			/* LN: 48 | CYCLE: 0 | RULES: () */ 
	a0g = xmem[__extractedConst_0_1 + 0]			# LN: 48 | 
	a0h = xmem[__extractedConst_0_1 + 1]			# LN: 48 | 
	a0l = xmem[__extractedConst_0_1 + 2]			# LN: 48 | 
	i0 = i7 - (0xa)			# LN: 48 | 
	xmem[i0] = a0g; i0 += 1			# LN: 48, 48 | 
	xmem[i0] = a0h; i0 += 1			# LN: 48, 48 | 
	xmem[i0] = a0l			# LN: 48 | 
cline_48_0:			/* LN: 49 | CYCLE: 0 | RULES: () */ 
	a0g = xmem[__extractedConst_1_1 + 0]			# LN: 49 | 
	a0h = xmem[__extractedConst_1_1 + 1]			# LN: 49 | 
	a0l = xmem[__extractedConst_1_1 + 2]			# LN: 49 | 
	i0 = i7 - (0xd)			# LN: 49 | 
	xmem[i0] = a0g; i0 += 1			# LN: 49, 49 | 
	xmem[i0] = a0h; i0 += 1			# LN: 49, 49 | 
	xmem[i0] = a0l			# LN: 49 | 
cline_49_0:			/* LN: 50 | CYCLE: 0 | RULES: () */ 
	a0g = xmem[__extractedConst_2_1 + 0]			# LN: 50 | 
	a0h = xmem[__extractedConst_2_1 + 1]			# LN: 50 | 
	a0l = xmem[__extractedConst_2_1 + 2]			# LN: 50 | 
	i0 = i7 - (0x10)			# LN: 50 | 
...
else_0:			/* LN: 52 | CYCLE: 0 | RULES: () */ 
	...
	a0l = xmem[i0]			# LN: 64 | 
	i0 = i7 - (0xa)			# LN: 64 | 
	a1g = xmem[i0]; i0 += 1			# LN: 64, 64 | 
	a1h = xmem[i0]; i0 += 1			# LN: 64, 64 | 
	b0 =+ a0			# LN: 64 | 
	a1l = xmem[i0]			# LN: 64 | 
	a0 =+ a1			# LN: 64 | 
	a0 = a0 >> 1; b0 = b0 >> 1			# LN: 64, 64 | 
	b0 - a0			# LN: 64 | 
	if (b > 0) jmp (else_1)			# LN: 64 | 
cline_64_0:			/* LN: 66 | CYCLE: 0 | RULES: () */ 
	...
	a0l = xmem[i0]			# LN: 66 | 
	i0 = i7 - (0x3)			# LN: 66 | 
	a1g = xmem[i0]; i0 += 1			# LN: 66, 66 | 
	a1h = xmem[i0]; i0 += 1			# LN: 66, 66 | 
	a1l = xmem[i0]			# LN: 66 | 
	a0 = a0 - a1			# LN: 66 | 
	i0 = i7 - (0x3)			# LN: 66 | 
	xmem[i0] = a0g; i0 += 1			# LN: 66, 66 | 
	xmem[i0] = a0h; i0 += 1			# LN: 66, 66 | 
	xmem[i0] = a0l			# LN: 66 | 
...
cline_69_0:			/* LN: 71 | CYCLE: 0 | RULES: () */ 
	...
	a0 = x0 * x1			# LN: 71 | 
	i0 = i7 - (0x14)			# LN: 71 | 
	xmem[i0] = a0g; i0 += 1			# LN: 71, 71 | 
	xmem[i0] = a0h; i0 += 1			# LN: 71, 71 | 
	xmem[i0] = a0l			# LN: 71 | 
...
cline_72_0:			/* LN: 73 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x14)			# LN: 73 | 
	a0g = xmem[i0]; i0 += 1			# LN: 73, 73 | 
	a0h = xmem[i0]; i0 += 1			# LN: 73, 73 | 
	a0l = xmem[i0]			# LN: 73 | 
...
else_1:			/* LN: 64 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x3)			# LN: 77 | 
	a0g = xmem[i0]; i0 += 1			# LN: 77, 77 | 
	a0h = xmem[i0]; i0 += 1			# LN: 77, 77 | 
	a0l = xmem[i0]			# LN: 77 | 
	i0 = i7 - (0x10)			# LN: 77 | 
	a1g = xmem[i0]; i0 += 1			# LN: 77, 77 | 
	a1h = xmem[i0]; i0 += 1			# LN: 77, 77 | 
	b0 =+ a0			# LN: 77 | 
	a1l = xmem[i0]			# LN: 77 | 
	a0 =+ a1			# LN: 77 | 
	a0 = a0 >> 1; b0 = b0 >> 1			# LN: 77, 77 | 
	b0 - a0			# LN: 77 | 
	if (b > 0) jmp (else_2)			# LN: 77 | 
cline_77_0:			/* LN: 79 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x3)			# LN: 79 | 
	a0g = xmem[i0]; i0 += 1			# LN: 79, 79 | 
	a0h = xmem[i0]; i0 += 1			# LN: 79, 79 | 
	a0l = xmem[i0]			# LN: 79 | 
	i0 = i7 - (0xa)			# LN: 79 | 
	a1g = xmem[i0]; i0 += 1			# LN: 79, 79 | 
	a1h = xmem[i0]; i0 += 1			# LN: 79, 79 | 
	a1l = xmem[i0]			# LN: 79 | 
	a0 = a0 - a1			# LN: 79 | 
	i0 = i7 - (0x3)			# LN: 79 | 
	xmem[i0] = a0g; i0 += 1			# LN: 79, 79 | 
	xmem[i0] = a0h; i0 += 1			# LN: 79, 79 | 
	xmem[i0] = a0l			# LN: 79 | 
cline_79_0:			/* LN: 81 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x3)			# LN: 81 | 
	a0g = xmem[i0]; i0 += 1			# LN: 81, 81 | 
	a0h = xmem[i0]; i0 += 1			# LN: 81, 81 | 
	a0l = xmem[i0]			# LN: 81 | 
	a0 = a0 >> 1			# LN: 81 | 
	i0 = i7 - (0x3)			# LN: 81 | 
...
cline_82_0:			/* LN: 84 | CYCLE: 0 | RULES: () */ 
	...
	a0 = x0 * x1			# LN: 84 | 
	i0 = i7 - (0x14)			# LN: 84 | 
	xmem[i0] = a0g; i0 += 1			# LN: 84, 84 | 
	xmem[i0] = a0h; i0 += 1			# LN: 84, 84 | 
	xmem[i0] = a0l			# LN: 84 | 
cline_84_0:			/* LN: 85 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x14)			# LN: 85 | 
	a0g = xmem[i0]; i0 += 1			# LN: 85, 85 | 
	a0h = xmem[i0]; i0 += 1			# LN: 85, 85 | 
	a0l = xmem[i0]			# LN: 85 | 
	a0 = a0 << 8			# LN: 85 | 
	a0 = a0 << 1			# LN: 85 | 
	i0 = i7 - (0x14)			# LN: 85 | 
	xmem[i0] = a0g; i0 += 1			# LN: 85, 85 | 
...
else_2:			/* LN: 77 | CYCLE: 0 | RULES: () */ 
	...
	a0 = a0 << 1			# LN: 92 | 
	i0 = i7 - (0xa)			# LN: 92 | 
	xmem[i0] = a0g; i0 += 1			# LN: 92, 92 | 
	xmem[i0] = a0h; i0 += 1			# LN: 92, 92 | 
	xmem[i0] = a0l			# LN: 92 | 
cline_92_0:			/* LN: 93 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0xa)			# LN: 93 | 
	a0g = xmem[i0]; i0 += 1			# LN: 93, 93 | 
	a0h = xmem[i0]; i0 += 1			# LN: 93, 93 | 
	a0l = xmem[i0]			# LN: 93 | 
	i0 = i7 - (0x3)			# LN: 93 | 
	a1g = xmem[i0]; i0 += 1			# LN: 93, 93 | 
	a1h = xmem[i0]; i0 += 1			# LN: 93, 93 | 
	a1l = xmem[i0]			# LN: 93 | 
	a0 = a0 - a1			# LN: 93 | 
	i0 = i7 - (0x3)			# LN: 93 | 
...
cline_93_0:			/* LN: 95 | CYCLE: 0 | RULES: () */ 
	...
	a0 = a0 >> 1			# LN: 95 | 
	i0 = i7 - (0x3)			# LN: 95 | 
	xmem[i0] = a0g; i0 += 1			# LN: 95, 95 | 
	xmem[i0] = a0h; i0 += 1			# LN: 95, 95 | 
	xmem[i0] = a0l			# LN: 95 | 
cline_95_0:			/* LN: 96 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x3)			# LN: 96 | 
	a0g = xmem[i0]; i0 += 1			# LN: 96, 96 | 
	a0h = xmem[i0]; i0 += 1			# LN: 96, 96 | 
	a0l = xmem[i0]			# LN: 96 | 
	i0 = i7 - (0x11)			# LN: 96 | 
	xmem[i0] = a0			# LN: 96 | 
cline_96_0:			/* LN: 98 | CYCLE: 0 | RULES: () */ 
	...
	a0 = x0 * x1			# LN: 98 | 
	i0 = i7 - (0x14)			# LN: 98 | 
	xmem[i0] = a0g; i0 += 1			# LN: 98, 98 | 
	xmem[i0] = a0h; i0 += 1			# LN: 98, 98 | 
	xmem[i0] = a0l			# LN: 98 | 
cline_98_0:			/* LN: 99 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x14)			# LN: 99 | 
	a0g = xmem[i0]; i0 += 1			# LN: 99, 99 | 
	a0h = xmem[i0]; i0 += 1			# LN: 99, 99 | 
	a0l = xmem[i0]			# LN: 99 | 
	a0 = a0 << 8			# LN: 99 | 
	a0 = a0 << 1			# LN: 99 | 
	i0 = i7 - (0x14)			# LN: 99 | 
	xmem[i0] = a0g; i0 += 1			# LN: 99, 99 | 
	xmem[i0] = a0h; i0 += 1			# LN: 99, 99 | 
	xmem[i0] = a0l			# LN: 99 | 
cline_99_0:			/* LN: 100 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x14)			# LN: 100 | 
	a0g = xmem[i0]; i0 += 1			# LN: 100, 100 | 
	a0h = xmem[i0]; i0 += 1			# LN: 100, 100 | 
	a0l = xmem[i0]			# LN: 100 | 
